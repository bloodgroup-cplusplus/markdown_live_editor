...
| GET /posts              → "Show me all blog posts"GET /posts/42           → "Show me post \#42"GET /users/john/posts   → "Show me all of John's posts" |
| :---- |
...
| POST /postsBody: {  "title": "My First Post",  "content": "Hello World\!"}→ Creates new post, returns Post ID: 43 |
| :---- |
...
| PUT /posts/42Body: {  "title": "Updated Title",  "content": "Completely new content",  "author": "Jane"}→ Replaces ALL fields of post \#42 |
| :---- |
...
| PATCH /posts/42Body: {  "title": "Just updating the title"}→ Only changes the title, keeps everything else |
| :---- |
